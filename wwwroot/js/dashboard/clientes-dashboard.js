...
document.addEventListener("DOMContentLoaded", () => {
    const app = document.querySelector("#clientes-dashboard-app");
    if (!app) {
        return;
    }
...
async function carregarDashboard(app, endpoint) {
...
function buildConicGradient(fatias, total) {
    let acumulado = 0;
